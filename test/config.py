...
def get_args():
  ...
  parser.add_argument('--max_words', type=int, default=10000, help='max words in vocab')
  parser.add_argument('--src_max_len', type=int, default=20, help='source max length')
  parser.add_argument('--tgt_max_len', type=int, default=20, help='target max length')
  ...
  #model details
  parser.add_argument('--embedding_size', type=int, default=100, help='dimension of embedding')
  parser.add_argument('--hidden_size', type=int, default=128, help='dimension of rnn hidden layer')
  ...
  parser.add_argument('--encoder_vocab_size', type=int, default=10003, help='encoder vocab size')
  parser.add_argument('--encoder_embed_size', type=int, default=500, help='dims of encoder embed')
  parser.add_argument('--decoder_vocab_size', type=int, default=10003, help='decoder vocab size')
  parser.add_argument('--decoder_embed_size', type=int, default=500, help='dims of decoder embed')
  parser.add_argument('--encoder_type', type=str, default="uni", help='encoder type')
  parser.add_argument('--beam_width', type=int, default=1, help='width of beam search')

  #optimizer details
  parser.add_argument('--nb_epoch', type=int, default=1, help='number of epoch')
